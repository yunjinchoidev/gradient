...
INSERT INTO OUTPUT values (seq_output.nextval, '1', '1', 1, 1,sysdate, 4,1,4,1);
SELECT * FROM OUTPUT;	
...
INSERT INTO team VALUES (seq_team.nextval, '기획 1팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '기획 2팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '기획 3팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '개발 1팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '개발 2팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '개발 3팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '고객 1팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '고객 2팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '고객 3팀', 3);
INSERT INTO team VALUES (seq_team.nextval, '기획 1팀', 3);
COMMIT;
	SELECT count(*) count FROM team WHERE projectkey=1;
SELECT count(*) count FROM team WHERE projectkey=1  and teamname like '기획%';
SELECT count(*) count FROM team WHERE projectkey=1  and teamname like '개발%';
SELECT count(*) count FROM team WHERE projectkey=1  and teamname like '고객%';
...
CREATE TABLE attendance (
	...
	memberkey NUMBER CONSTRAINT attendance_memberkey_fk REFERENCES MEMBER(memberkey) ON DELETE CASCADE,
	score NUMBER
)
