...
public class NoticeSch {
	...
	public NoticeSch(int count, int pageSize, int pageCount, int curPage, int start, int end, int blockSize,
			int startBlock, int endBlock, String title, String content) {
		super();
		this.count = count;
