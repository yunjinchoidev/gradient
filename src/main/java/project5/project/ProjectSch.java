...
public class ProjectSch {
	...
	public ProjectSch(int count, int pageSize, int pageCount, int curPage, int start, int end, int blockSize,
			int startBlock, int endBlock, String name, String contents) {
		super();
		this.count = count;
