...
public class ProcuSituationSch {
	// 페이징 처리
	...
	public ProcuSituationSch() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ProcuSituationSch(int count, int pageSize, int pageCount, int curPage, int start, int end, int blockSize,
