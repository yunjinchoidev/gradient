...
[online example browser](https://bryntum.com/examples/scheduler-pro/#Integration/Ionic).

## Build and run local demos

Ionic demos are located in **examples-scheduler/frameworks/ionic** folder
...
Another valid method is to pass a [`listeners`](https://bryntum.com/docs/scheduler-pro/api/Core/mixin/Events#config-listeners)
