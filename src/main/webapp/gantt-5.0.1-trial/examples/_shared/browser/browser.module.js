import { Store, AjaxHelper, BrowserHelper, DomHelper, DomSync, EventHelper, Toolbar, Popup, Widget, GlobalEvents, VersionHelper, FunctionHelper } from '../../../build/gantt.module.js?457330';
...
class ExamplesApp {
    constructor() {
        ...
        me.beforeLoadScrollPos = document.getElementById('browser').scrollTop;
        ...
        EventHelper.on({
            ...
            click(event) {
                ...
                new Popup({
                    ...
                    html       : me.buildTip + `The demo can be found in distribution folder: <i class="b-fa b-fa-folder-open"></i><b>` +
