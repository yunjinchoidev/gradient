...
}, // Export
{
  ...
  group: 'Export & Import',
  title: 'Import MS Project MPP files',
  since: '1.1.3'
}, {
  folder: 'export',
  group: 'Export & Import',
...
}, // Integration/Angular
{
  ...
  group: 'Integration/Angular',
  title: 'Inline data in Angular Gantt',
  overlay: 'angular',
  version: 'Angular 13',
  since: '5.0.0',
  build: true
  ...
  group: 'Integration/Angular',
  title: 'Angular Gantt + Scheduler Pro',
  overlay: 'angular',
  version: 'Angular 13',
  updated: '4.3.4',
  build: true,
  ...
  group: 'Integration/Angular',
  title: 'Angular Task editor customization',
  overlay: 'angular',
  version: 'Angular 13',
  updated: '4.3.4',
  build: true,
...
}, // 'Integration/React
{
  ...
  group: 'Integration/React',
  title: 'React Gantt + Scheduler Pro',
  overlay: 'react',
  version: 'React 17',
  build: true,
  since: '4.2.0'
  ...
  group: 'Integration/React',
  title: 'Inline data in React Gantt',
  overlay: 'react',
  version: 'React 17',
  since: '5.0.0',
  build: true
  ...
  group: 'Integration/React',
  title: 'React Gantt Resource Histogram',
  overlay: 'react',
  version: 'React 17',
  build: true,
  since: '4.1.1'
  ...
  group: 'Integration/React',
  title: 'React Task editor customization',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '2.0.1'
  ...
  group: 'Integration/React',
  title: 'React Basics with TypeScript',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '1.1.3'
  ...
  group: 'Integration/React',
  title: 'React SharePoint Workbench with TypeScript',
  overlay: 'react',
  version: 'React 16',
  build: true,
  offline: true,
...
}, // Integration/Vue
{
  ...
  group: 'Integration/Vue',
  title: 'Inline data in Vue Gantt',
  overlay: 'vue',
  version: 'Vue 2',
  since: '5.0.0',
  build: true
  ...
  group: 'Integration/Vue',
  title: 'Vue Task editor customization',
  overlay: 'vue',
  version: 'Vue 2',
  build: true,
  since: '2.0.1'
...
}, // Integration/Vue-3
{
  ...
  group: 'Integration/Vue',
  title: 'Vue 3 Gantt + Scheduler Pro',
  overlay: 'vue',
  version: 'Vue 3',
  build: true,
  since: '4.2.0'
  ...
  group: 'Integration/Vue',
  title: 'Inline data in Vue 3 Gantt',
  overlay: 'vue',
  version: 'Vue 3',
  since: '5.0.0',
  build: true
