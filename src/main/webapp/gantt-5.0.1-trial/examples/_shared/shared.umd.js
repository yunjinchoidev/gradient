...
class Shared extends Localizable(Events()) {
  ...
  constructor() {
    ...
    if (isBryntumCom && !VersionHelper.isTestEnv) {
      console.log(`%c TIP! %cYou can access the widget used in the demo on the console using %cwindow.${me.product.name}`, 'color: orange; font-weight: bold', 'color : initial', 'font-family: monospace');
    }
  }
  /**
