import { LocaleManager, Localizable, AsyncHelper, AjaxHelper, DomHelper, Button, Popup, Tooltip, Toast, Widget, BrowserHelper, EventHelper, ResizeHelper, VersionHelper, DataGenerator, Fullscreen, Events, GlobalEvents, Rectangle, TrialButton, Base, Menu } from '../../build/thin/core.module.thin.js?457330';
import '../_shared/product.module.js?457330';
/* global RC */
// Load product config
...
const
    ...
    isModule             = pathName.endsWith('module.html') || (moduleTag?.src.includes('app.module.js?457330')) || (pathName.endsWith('index.html') && isBryntumCom),
...
class Shared extends Localizable(Events()) {
    ...
    constructor() {
        ...
        if (isBryntumCom && !VersionHelper.isTestEnv) {
            console.log(
                `%c TIP! %cYou can access the widget used in the demo on the console using %cwindow.${me.product.name}`,
    ...
    fireMouseEvent(type, target, offset = [0, 0]) {
        const { center } = Rectangle.from(target);
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?457330' : isUmd ? 'app.umd.js?457330' : 'app.js?457330',
                    items    : [
                        isModule ? 'app.module.js?457330' : isUmd ? 'app.umd.js?457330' : 'app.js?457330'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?457330' : isUmd ? 'app.umd.js?457330' : 'app.js?457330') {
        const
            me = this;
        ...
        if (filename.endsWith('.js?457330')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?457330')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?457330') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?457330"]')) {
            filesStore.add({
                text  : 'resources/app.css?457330',
                value : 'resources/app.css?457330'
            });
        }
