import { Gantt, ProjectModel, TaskTooltip, DateHelper, StringHelper } from '../../build/gantt.module.js?457330';
...
const gantt = new Gantt({
    ...
    columns : [
        { type : 'name', field : 'name', width : 250 },
        {
            ...
            width       : 120,
            showAvatars : true,
            avatarTooltipTemplate({ resourceRecord, assignmentRecord, overflowCount }) {
                return `
