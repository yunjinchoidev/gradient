    ...
    items: {
      ...
      recalculateBtn: {
        ...
        onClick: async ({
          ...
          // Enable calculations
          await project.setCalculations(calculationsBackup); // Toggle buttons
...
project.setCalculations(dummyCalculations).then(oldCalculations => {
  calculationsBackup = oldCalculations; // enable recalculate button after calculationsBackup variable is filled
