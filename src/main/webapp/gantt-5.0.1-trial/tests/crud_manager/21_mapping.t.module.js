import { ResourceModel } from '../../build/gantt.module.js?457330';
/* globals ProjectModel */

StartTest(t => {
    let project;

    t.beforeEach(() => ResourceModel.destroy(project));
    ...
    t.it('Resource should not throw when trying to serialize calendar field', async t => {
        ...
        const newCalendar = project.calendarManagerStore.add({ id : 'new' })[0];
