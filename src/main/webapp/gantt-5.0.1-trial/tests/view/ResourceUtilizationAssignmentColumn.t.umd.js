...
StartTest(t => {
  let project, resourceStore, assignmentStore, gantt, panel;
  ...
  t.it('Refresh on assignment column editing', async t => {
    ...
    await t.click('label:textEquals(Save)'); // clicking next row to finish editing & apply the change
    ...
    await t.doubleClick('.b-resourceassignment-cell'); // clicking remove icon
