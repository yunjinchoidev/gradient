    ...
    t.it('Should set project start/end as Gantt timespan after loading', async t => {
        gantt = new Gantt({
            ...
            tasks : [
                ...
                { id : 2, name : 'Later Task', startDate : new Date(2021, 8, 18), duration : 2, durationUnit : 'd', constraintType : 'muststarton', constraintDate : '2021-09-18' }
            ]
        });
