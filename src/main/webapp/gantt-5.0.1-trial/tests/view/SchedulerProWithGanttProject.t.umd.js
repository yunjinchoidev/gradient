...
StartTest(t => {
  ...
  async function createScheduler(t, config = {}, projectConfig = {}) {
    project = new ProjectModel(Object.assign({
      tasksData: [{
        ...
        children: [{
          id: 11,
          name: 'Imprison Batman',
          startDate: new Date(2020, 5, 18),
          duration: 4
        }, {
          id: 12,
          name: 'Activate overcomplicated trap',
          duration: 4
        }]
      }],
      resourcesData: [{
  ...
  t.it('Features sanity', t => {
    t.it('Drag', async t => {
      ...
      const dragged = project.taskStore.getById(11),
    ...
    t.it('Resize', async t => {
      ...
      await t.waitForProjectReady(project);
      const resized = project.taskStore.getById(11),
            linked = project.taskStore.getById(12);
    ...
    t.it('TaskEditor', async t => {
      ...
      await t.waitForProjectReady(project);
      const edited = project.taskStore.getById(11),
            linked = project.taskStore.getById(12);
