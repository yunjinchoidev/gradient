import { DomHelper } from '../../build/gantt.module.js?457330';
...
StartTest(t => {
    ...
    t.it('Should display terminals for task moved by propagate', async t => {
    ...
    t.it('Should not fail on hover over task and dependencies', t => {
        ...
        DomHelper.forEachSelector(gantt.element, '.b-sch-dependency', element => {
