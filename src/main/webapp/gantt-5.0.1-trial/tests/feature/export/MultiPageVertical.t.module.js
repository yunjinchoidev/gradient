import { DateHelper, Override, ProjectGenerator, RandomGenerator, PresetManager, PaperFormat, RowsRange, Rectangle, ScheduleRange, CSSHelper } from '../../../build/gantt.module.js?457330';
...
StartTest(t => {
    ...
    t.it('Should export visible schedule', async t => {
        ...
        await gantt.await('visibleRangeChange', { checkLog : false });
