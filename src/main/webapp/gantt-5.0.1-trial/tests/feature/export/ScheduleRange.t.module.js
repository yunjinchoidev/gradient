import { DateHelper, DomHelper, Override, ProjectGenerator, RandomGenerator, Gantt, PresetManager, PaperFormat, RowsRange, ScheduleRange, Rectangle, CSSHelper } from '../../../build/gantt.module.js?457330';
            ...
            async() => {
                ...
                function assertContent(doc) {
                    const
                        ...
                        { startDate, endDate }         = gantt.visibleDateRange,
