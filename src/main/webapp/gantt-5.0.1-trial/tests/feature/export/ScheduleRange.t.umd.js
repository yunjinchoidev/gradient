  ...
  t.it('Should export visible schedule', async t => {
    ...
    t.chain({
      ...
      function assertContent(doc) {
        ...
        t.isApprox(ganttBox.height, 500, DomHelper.scrollBarWidth + 1, 'Gantt height is ok');
        ...
        const events = taskStore.query(r => {
      ...
      await gantt.scrollToDate(gantt.timeAxis.getAt(6).startDate, {
        block: 'start'
      ...
      await doExport(ScheduleRange.currentview, 'singlepage', 1, assertContent); // This timeout is required to make this test pass is headless, scrollbarless chrome in puppeteer
