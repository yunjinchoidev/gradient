StartTest(t => {
    ...
    t.it('Spin buttons of start/end fields skip non-working time', async t => {
        ...
        t.chain(
            ...
            { click : '.b-start-date .b-icon-angle-left', desc : 'Start date -1 day' },
            ...
            { click : '.b-start-date .b-icon-angle-right', desc : 'StartDate +1 day' },
            { waitFor : () => gantt.isEngineReady },
            async() => {
            ...
            { click : '.b-end-date .b-icon-angle-right', desc : 'EndDate +1 day' },
            { waitFor : () => gantt.isEngineReady },
            async() => {
                t.is(event.startDate, new Date(2020, 9, 19), 'event start date got updated');
            ...
            { click : '.b-end-date .b-icon-angle-left', desc : 'EndDate -1 day' },
            { waitFor : () => gantt.isEngineReady },
            async() => {
                t.is(event.startDate, new Date(2020, 9, 19), 'event start date got updated');
                t.is(event.endDate, new Date(2020, 9, 24), 'event end date got updated');
    ...
    t.it('Start/end fields support keepTime === entered mode', async t => {
        ...
        gantt = await t.getGanttAsync({
            ...
            project : {
                ...
                eventsData : [
                    { id : 1, name : 'Event 1', startDate : '2021-01-12', duration : 48, durationUnit : 'hours' }
                ],
        ...
        t.chain(
            ...
            { click : '[name="startDate"]', desc : 'Clicked startDate field' },
            { type : '2021-01-12 18:45[TAB]', clearExisting : true, desc : 'Entered date' },
            ...
            { click : '.b-start-date .b-icon-calendar', desc : 'Clicked picker icon' },
            { click : '[aria-label="January 14, 2021"]', desc : 'Clicked a date' },
            ...
            { click : '.b-end-date .b-icon-calendar', desc : 'Clicked picker icon' },
            { click : '[aria-label="January 15, 2021"]', desc : 'Clicked a date' },
            ...
            { click : '[name="endDate"]', desc : 'Clicked endDate field' },
            { type : '2021-01-17 18:45[TAB]', clearExisting : true, desc : 'Entered date' },

            { waitFor : () => gantt.isEngineReady },

            async() => {
                t.is(event.startDate, new Date(2021, 0, 14, 18, 45), 'event start date is correct');
                t.is(event.endDate, new Date(2021, 0, 16), 'event end date is correct');
                // duration is: 5h15m + 24h
