...
StartTest(function (t) {
  ...
  t.it('Should render critical paths', async t => {
    ...
    t.chain({
      ...
      waitForSelector: '.b-sch-dependency.b-critical',
      desc: 'Dependency got highlighted'
    }, async () => {
      ...
      waitForSelector: 'polyline[depId="58"].b-sch-dependency.b-critical',
      desc: 'Path for task 7 was highlighted, critical path feature CSS class was added'
    }, next => {
      const task7PathEl = gantt.element.querySelector('polyline[depId="58"]'),
            task11ElCoord = t.rect('[data-task-id="11"]'),
            arrowMargin = gantt.features.dependencies.pathFinder.startArrowMargin; // check if the element found on point is the critical
      ...
      waitForSelectorNotFound: 'polyline[depId="58"].b-sch-dependency.b-critical',
      desc: 'Path for task 7 was not highlighted, critical path feature CSS class was removed'
    }, {
      ...
      waitForSelectorNotFound: '.b-sch-dependency.b-critical',
      desc: 'no highlighted dependency'
    });
