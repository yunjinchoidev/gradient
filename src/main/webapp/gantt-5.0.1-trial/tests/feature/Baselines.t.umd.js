...
StartTest(t => {
  ...
  t.it('Baseline tooltip', async t => {
    ...
    await t.moveMouseTo('[data-task-id="baselinesFor1"] .b-task-baseline'); // And we should get a tip for that baseline
  ...
  t.it('Baseline of a milestone task where baseline was not a milestone should not show diamond ', async t => {
    ...
    t.selectorCountIs('.b-task-baseline-milestone:first-child', 1, '1 milestone baseline task'); // https://developer.mozilla.org/en-US/docs/Web/API/Window/getComputedStyle
