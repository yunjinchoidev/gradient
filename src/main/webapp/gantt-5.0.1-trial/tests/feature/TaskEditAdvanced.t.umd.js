  ...
  t.describe('Advanced form works ok', t => {
    ...
    t.it('Should set constraints', async t => {
      ...
      t.chain(async () => {
        ...
        type: 's',
        clearExisting: true,
        desc: 'Type "s" to start autocomplete'
      }, {
        ...
        type: '[ENTER]',
        desc: 'ENTER click to submit first value in the list'
      }, {
        waitForProjectReady: gantt,
        desc: 'Project is ready after constraint type is set'
      }, async () => {
        ...
        waitForProjectReady: gantt,
        desc: 'Project is ready after constraint date is set'
      }, async () => {
    ...
    t.it('Should have only constraint types applicable available for cell and popup editors', async t => {
      ...
      const task1 = gantt.store.getById(1),
    ...
    t.it('Just setting a constraint should not cause a conflict', t => {
      ...
      t.chain({
        ...
        type: 'm',
        clearExisting: true,
        desc: 'Type "m" to start autocomplete'
      }, {
