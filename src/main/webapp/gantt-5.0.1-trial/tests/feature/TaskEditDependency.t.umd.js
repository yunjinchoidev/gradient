...
StartTest(t => {
  ...
  t.it('Adding invalid dependency should be handled properly', async t => {
    ...
    t.chain({
      ...
      click: '.b-grid',
      desc: 'Clicked outside to finish cell editing'
    }, {
      moveMouseTo: '.b-grid .b-cell-editor'
    }, {
      waitForSelector: '.b-field-error-tip:contains(Cyclic dependency)',
      desc: 'Proper error tooltip is found'
    }, {
      click: '.b-button:contains(Save)'
    }, {
      waitFor: 100
      ...
      desc: 'Task editor stays open. Since the input is invalid'
    }, {
      click: '.b-button:contains(Cancel)'
    }, {
      waitForSelectorNotFound: '.b-gantt-taskeditor',
  ...
  t.it('Removing of invalid phantom dependency should work', async t => {
    ...
    t.chain({
      ...
      click: '.b-add-button',
      decs: 'Clicked to add a dependency'
    }, {
      click: '.b-grid',
      desc: 'Clicked outside to finish cell editing'
    }, {
      dblclick: '.b-grid-cell[data-column=fromEvent]',
      desc: 'Double Clicked to start cell editing again'
    }, {
      click: '.b-remove-button',
      desc: 'Clicked to remove the dependency'
    }, {
      click: '.b-button:contains(Cancel)'
    });
  });
  ...
  t.it('Should not remove successor column name when add invalid successor', async t => {
    ...
    t.chain({
      ...
      waitForSelector: '.b-cell-editor[data-field="toEvent"] .b-invalid input[__lastvalue="Choose technology suite"]',
      desc: 'Value on combo is correct with invalid flag'
    }, {
      ...
      waitForSelector: '[data-column="toEvent"]:contains(Follow up with customer (234))',
      desc: 'The current valid successor is still present'
    }, next => {
      ...
      waitForSelector: '.b-cell-editor[data-field="fromEvent"] .b-invalid input[__lastvalue="Follow up with customer"]',
      desc: 'Value on combo is correct with invalid flag'
    }, {
      ...
      waitForSelector: '[data-column="fromEvent"]:contains(Choose technology suite (22))',
      desc: 'The current valid predecessor is still present'
    }, next => {
      ...
      waitForSelector: '[data-column="fromEvent"]:contains(Choose technology suite (22))',
      desc: 'Reverted to the valid predecessor'
    }, next => {
      ...
      waitForSelector: '[data-column="toEvent"]:contains(Follow up with customer (234))',
      desc: 'Reverted to the valid successor'
    }, () => {
  ...
  t.it('Should use correct stores after replacing project', async t => {
    ...
    const {
      widgetMap
    } = gantt.features.taskEdit.editor;
