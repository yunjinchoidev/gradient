...
StartTest(t => {
    ...
    t.it('Rollups should render child tasks under parent task bar', async t => {
        ...
        t.chain(
            ...
            { moveMouseTo : '.b-task-rollup[data-index="2"]', offset : ['50%+1', '50%'] },
            ...
            { waitForSelectorNotFound : '.b-task-rollup[data-index="2"]', desc : 'Rollups are trimmed on child remove' },
            ...
            { waitForSelector : '.b-task-rollup[data-index="2"]', desc : 'Rollups are added on child add' }
        );
    });
    ...
    t.it('Should not overlap rollup and baselines when combined', async t => {
        ...
        const
            rollupElCoord = t.rect('.b-task-rollup[data-rollup-task-id="2"]'),
