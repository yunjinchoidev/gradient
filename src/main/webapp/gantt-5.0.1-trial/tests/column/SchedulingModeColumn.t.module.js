import { SchedulingModeColumn } from '../../build/gantt.module.js?457330';
...
StartTest((t) => {
    ...
    t.it('Should render properly when no editor available', async t => {
        gantt = t.getGantt({
            appendTo : document.body,
            id       : 'gantt',
            columns  : [
                { type : SchedulingModeColumn.type, editor : false }
            ]
        });
