...
StartTest(t => {
  ...
  t.it('Should apply value instantly after spin', async t => {
    ...
    const task = gantt.taskStore.getById(11); // Update fires twice for the task and twice for the project
  ...
  t.it('Should show error tooltip when finalizeCellEditor returns false', t => {
    ...
    t.chain({
      ...
      t.selectorExists('.b-durationfield.b-invalid'); // destroy to avoid throw missing locale for 'fool' when move the focus mouse after finish the test (Safari problem)
