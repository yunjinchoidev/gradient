...
StartTest(t => {
    ...
    t.it('Should be able to change constraint type/date', t => {
        ...
        t.chain(
            ...
            { dblclick : '.id1 [data-column=constraintDate]', desc : 'Constraint date column dbl-clicked' },
    ...
    t.it('Should be able to filter constraint type combo', t => {
        ...
        t.chain(
            ...
            { dblclick : '.id11 [data-column=constraintType]', desc : 'Constraint type column dbl-clicked' },

            { type : 'f[ENTER][ENTER]', desc : 'Typed "f" to pick start no earlier than' },
            ...
            { click : '.id12 [data-column=constraintDate]', desc : 'Constraint date column clicked' },

            { dblclick : '.id12 [data-column=constraintType]', desc : 'Constraint type column dbl-clicked' },
