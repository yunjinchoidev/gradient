import { Grid, Gantt, ProjectModel } from '../../build/gantt.module.js?457330';
...
StartTest(t => {
    ...
    t.it('Gantt + Grid with thin bundle sanity', async t => {
        const project = new ProjectModel({
            tasks       : [{ id : 1, name : 'Event 1', startDate : '2022-02-11', duration : 5 }],
        ...
        t.selectorExists('.b-gantt .b-grid-row', 'Scheduler row rendered');
