import { TaskBoard, Gantt, ProjectModel } from '../../build/gantt.module.js?457330';
...
StartTest(t => {
    ...
    t.it('Gantt + TaskBoard with thin bundle sanity', async t => {
            ...
            tasks : [
                {
                    ...
                    name     : 'Parent 1',
                    children : [
                        { id : 2, name : 'Event 1', startDate : '2022-02-11T8', duration : 5, durationUnit : 'h', status : 'todo' },
                        { id : 3, name : 'Event 2', startDate : '2022-02-11T8', duration : 5, durationUnit : 'h', status : 'done' }
                    ]
                }
            ],
        ...
        t.selectorCountIs('.b-gantt-task', 1, 'Gantt parent task rendered');
