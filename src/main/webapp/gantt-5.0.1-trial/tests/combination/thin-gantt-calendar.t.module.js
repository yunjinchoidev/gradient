import { Calendar, Gantt, ProjectModel, DomHelper } from '../../build/gantt.module.js?457330';

StartTest(t => {
    t.beforeEach(() => Calendar.destroy(...Calendar.queryAll(w => !w.parent)));

    t.it('Gantt + Calendar with thin bundle sanity', async t => {
        ...
        // Ensure css worked
        t.isApproxPx(t.rect('.b-gantt-task').left, 810, 2, 'Task has correct x');
