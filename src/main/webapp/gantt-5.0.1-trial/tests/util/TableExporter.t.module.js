import { TableExporter, DateHelper } from '../../build/gantt.module.js?457330';
...
StartTest(t => {
    ...
    t.it('Exported columns should be properly converted to strings', async t => {
        ...
        t.ok(typeof row[row.length - 1] === 'string', 'WBS is exported as string');
        ...
        t.isDeeply(row, [
            ...
            'Task 3',
            '',
            '34', // percent done exported as number
            '1;2',
