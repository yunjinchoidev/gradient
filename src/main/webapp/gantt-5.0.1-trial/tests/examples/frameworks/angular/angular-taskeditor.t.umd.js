...
describe('Test Taskeditor demo', function (t) {
  ...
  t.it('Check task editor tabs', t => {
    t.chain({
      ...
      waitForSelector: 'button.b-active:textEquals(Files)',
      desc: 'Can activate Files tab'
    }, {
      click: ':textEquals(Common)'
    }, {
      waitForSelectorNotFound: 'i.b-icon-note',
      desc: 'Notes tab is not present'
    }, {
      click: ':textEquals(Common)'
    }, {
      waitForSelector: 'button.b-active:textEquals(Common)'
