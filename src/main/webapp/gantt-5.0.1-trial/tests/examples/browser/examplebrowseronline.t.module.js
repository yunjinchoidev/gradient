StartTest(t => {
    ...
    t.it('Check tooltips for examples available online', t => {
        t.chain(
            ...
            { waitForSelector : '#b-example-frameworks-angular-advanced i.b-fa-info', desc : 'Correct info icon used' },
    ...
    t.it('Check tooltips for examples not available online', t => {
        t.chain(
            ...
            { waitForSelector : '#b-example-frameworks-webpack i.b-fa-cog', desc : 'Correct info icon used' },
