...
StartTest(t => {
  ...
  t.it('Should export Gantt to Microsoft Project', async t => {
    ...
    const exporter = gantt.features.mspExport,
    ...
    t.is(tasksEl.childNodes.length, gantt.taskStore.count, 'proper number of tasks exported'); // TODO: feature to export assignments in progress
