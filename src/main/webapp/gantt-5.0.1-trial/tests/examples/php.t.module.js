StartTest(t => {
    ...
    t.it('Task sort order should be stored on server', (t) => {
        ...
        t.chain(
            ...
            () => gantt.scrollable.scrollTo(null, 0),
            {
                ...
                trigger      : { drag : '.b-grid-row:contains(Configure firewall)', offset : [150, '50%'], by : [0, -60] },
                desc         : 'Task dragged'
            },
    ...
    t.it('Should be able to drag newly created task', (t) => {
        ...
        t.chain(
            ...
            {
                waitForEvent : [gantt.project, 'haschanges'],
                trigger      : { type : 'Drag task[TAB]', target : '.b-cell-editor input', options : { clearExisting : true } }
            },
            next => {
            ...
            {
                waitForEvent : [gantt.project, 'haschanges'],
                trigger      : { drag : '.b-grid-row:contains(Drag task)', offset : [150, '50%'], by : [0, -60] },
                desc         : 'Task dragged'
            },
            () => {
