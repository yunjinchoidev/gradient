...
StartTest(t => {
    ...
    if (t.url.includes('online-bundles')) {
        ...
        const onlineVersionHelper = window.VersionHelper?.scheduler || window.bryntum.scheduler.VersionHelper?.scheduler;
        t.diag(`Online version is ${onlineVersionHelper.version}`);

        // Disable testing with the older online versions
    ...
    switch (t.getMode()) {
        ...
        case 'module' :
            gridConfig.appendTo = schedulerConfig.appendTo = ganttConfig.appendTo = document.body;
