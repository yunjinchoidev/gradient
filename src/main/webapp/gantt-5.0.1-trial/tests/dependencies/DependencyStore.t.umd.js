...
StartTest(t => {
  ...
  t.beforeEach(() => {
    var _dependencyStore, _taskStore, _project;

    (_dependencyStore = dependencyStore) === null || _dependencyStore === void 0 ? void 0 : _dependencyStore.destroy();
    dependencyStore = null;
    (_taskStore = taskStore) === null || _taskStore === void 0 ? void 0 : _taskStore.destroy();
    taskStore = null;
  ...
  t.it('Should be able to consume own json', async t => {
    ...
    dependencyStore.add({
      id: 2,
      fromEvent: taskStore.getById(2),
      toEvent: taskStore.getById(3)
    });
    await project.commitAsync();
