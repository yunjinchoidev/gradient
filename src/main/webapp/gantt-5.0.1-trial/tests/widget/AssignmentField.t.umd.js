...
StartTest(t => {
  ...
  t.beforeEach(t => {
    ...
    return (_field = field) === null || _field === void 0 ? void 0 : _field.destroy();
  });
  ...
  t.it('Should reflect correct field value upon save button click', async t => {
    ...
    t.chain({
      ...
      t.isDeeply(maximAssignments.map(a => ({
        event: a.event,
        units: a.units
