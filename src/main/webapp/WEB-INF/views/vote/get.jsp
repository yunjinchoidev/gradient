	...
	$(document)
			.ready(
					function() {
						...
						var votekey = parseInt("${get.votekey}");
						var voteItem1 = parseInt("${get.voteItem1}");
						var voteItem2 = parseInt("${get.voteItem2}");
						var voteItem3 = parseInt("${get.voteItem3}");
						var voteItem4 = parseInt("${get.voteItem4}");
						...
						$("#voting")
								.click(
										function(e) {
											e.preventDefault();
											whatVote = $("[name=item]:checked")
													.val();
											confirm("정말 투표하시겠습니까? : "
													+ whatVote);
											console.log("whatVote : "
													+ whatVote);
											//formObj.submit();
											...
											$
													.ajax({
														...
														success : function(
																result) {
															alert("투표에 성공했습니다.")
															location.href = "/project5/projectHome.do?projectkey=${get.projectkey}"
														},
