...
<script>
	$(document).ready(function() {
		...
		$("#groupBtn").click(function(e) {
			...
			var array = new Array();
			array.push(${member.memberkey})
					$('input:checkbox[name=memberkey]:checked').each(function() {
						array.push(this.value);
						console.log(this.value);
					})
			alert("선택한 회원들 : "+array);
			location.href="/project5/chattingGroupInvitation.do?arrayParam="+array;
		})
		...
		$("#individualBtn").click(function(e) {
				...
				location.href="/project5/chattingIndividualInvitation.do?memberkey="+choiceMemberkey
						*/
				var array = new Array();
				array.push(${member.memberkey})
		...
		<div class="page-heading">
			...
			<section class="section">
				<div class="card">
					...
					<div class="card-body">
							<form id="frm01" class="form" action="/project5/chattingInvitationList.do"
							method="post">
							<div
