	...
	$(document).ready(function() {
						...
						$("#pjList").change(function() {
											...
											console.log(selectedval)
												...
												$("#pjList option:eq(selectedval-1)").prop('selected',true)
										})
...
<body>
	...
	<div class="buttons" id="moveBtn" style="padding: 20px;">
		<a href="/project5/projectHome.do?projectkey=1"
			...
			class="btn btn-secondary">일정관리</a> <a
			...
			class="btn btn-dark">조달 관리</a> <a
			href="/project5/team.do?projectkey=${project.projectkey }"
			class="btn btn-danger">인적 관리</a> <a
			href="/project5/risk.do?projectkey=${project.projectkey }"
			class="btn btn-danger">리스크 관리</a>
	</div>
