...
<script>
	$(document).ready(function() {
		...
		var pageSize = "${kanbanSch.pageSize}"
			...
			<div class="page-title">
				<div class="row">
					<div class="col-12 col-md-6 order-md-1 order-last">
						<h3><span style="color:red">${member.name }</span>님의 작업 목록 - 칸반 작업</h3>
										...
										<div class="email-action">
											...
											<div class="action-left d-flex align-items-center">
												...
												<form id="frm01" class="form"
													action="${path}/myWork2.do?memberkey=${member.memberkey}"
													method="post">
													<div
														...
														<div class="dataTable-top">
															<div class="input-group-prepend">
																<input type="hidden" name="curPage" value="1" /> <span
																	class="input-group-text">총 ${kanbanSch.count}건</span>
															</div>
												...
												<div class="dataTable-bottom">
													<ul class="pagination  justify-content-end">
														<li class="page-item"><a class="page-link"
															href="javascript:goPage(${kanbanSch.startBlock!=1?kanbanSch.startBlock-1:1})">Previous</a></li>
														<c:forEach var="cnt" begin="${kanbanSch.startBlock}"
															end="${kanbanSch.endBlock}">
															<li
																class="page-item ${cnt==kanbanSch.curPage?'active':''}">
																<!-- 클릭한 현재 페이지 번호 --> <a class="page-link"
																href="javascript:goPage(${cnt})">${cnt}</a>
															</li>
														</c:forEach>
														<li class="page-item"><a class="page-link"
															href="javascript:goPage(${kanbanSch.endBlock!=kanbanSch.pageCount?kanbanSch.endBlock+1:kanbanSch.endBlock})">Next</a></li>
													</ul>
												</div>
											...
											<ul class="users-list-wrapper media-list">
												...
												<c:forEach var="list" items="${list }" varStatus="var">
													<li class="media mail-read"
														onclick="window.open('/project5/myWorkKanbanGet.do?id=${list.id}','팝업창','width=500, height=610, left=400, top=200');">
														...
														<div class="media-body">
															<div class="user-details">
																...
																<div class="mail-items">
																	<span class="list-group-item-text text-truncate">[${list.id}]${list.status}</span>
																</div>

																<div class="mail-meta-item">
																	<span class="float-right"> <span
																		class="mail-date">${list.duedate }</span>
																	</span>
																</div>
															...
															<div class="mail-message">
																...
																<div class="mail-meta-item">
																	<span class="float-right"> <span
																		class="bullet bullet-success bullet-sm">${list.tags }</span>
																	</span>
																</div>
															</div>
														</div>
