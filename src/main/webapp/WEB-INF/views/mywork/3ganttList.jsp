...
<script>
	$(document).ready(function() {
		...
		var pageSize = "${ganttSch.pageSize}"
														...
														<div class="dataTable-top">
															<div class="input-group-prepend">
																<input type="hidden" name="curPage" value="1" /> <span
																	class="input-group-text">총 ${ganttSch.count}건</span>
															</div>
												...
												<div class="dataTable-bottom">
													<ul class="pagination  justify-content-end">
														<li class="page-item"><a class="page-link"
															href="javascript:goPage(${ganttSch.startBlock!=1?ganttSch.startBlock-1:1})">Previous</a></li>
														<c:forEach var="cnt" begin="${ganttSch.startBlock}"
															end="${ganttSch.endBlock}">
															<li
																class="page-item ${cnt==ganttSch.curPage?'active':''}">
																<!-- 클릭한 현재 페이지 번호 --> <a class="page-link"
																href="javascript:goPage(${cnt})">${cnt}</a>
															</li>
														</c:forEach>
														<li class="page-item"><a class="page-link"
															href="javascript:goPage(${ganttSch.endBlock!=ganttSch.pageCount?ganttSch.endBlock+1:ganttSch.endBlock})">Next</a></li>
													</ul>
												</div>
