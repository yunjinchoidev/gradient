...
<script>
	$(document)
			.ready(
					function() {
						var procurementkey = "${get.procurementkey}"
						console.log("procurementkey : " + procurementkey);
						$("#del")
								.click(
										function() {
											confirm("정말 삭제하시겠습니까?");
											location.href = "/project5/procurementDelete.do?procurementkey="
													+ procurementkey;
										})
						...
						$("#update")
								.click(
										function() {
											confirm("정말 수정하시겠습니까?");
											location.href = "/project5/procurementUpdateFrom.do?procurementkey="
													+ procurementkey;
										})
...
<script>
	$(document).ready(function() {
						var procurementkeyValue = '<c:out value="${procurement.procurementkey}"/>';
						var replyUL = $(".chat");
						...
						function showList(page) {
							...
							replyService.getList({procurementkey : procurementkeyValue,
												page : 1
											},
											function(list) {
						...
						modalRegisterBtn.on("click", function(e) {
							var reply = {
								...
								procurementkey : procurementkeyValue
							};
...
<script>
	...
	/*
	 replyService.add(
	 {reply:"JS Test", replyer:"tester", procurementkey:procurementkeyValue}
	 ,
	 function(result){ 
