			...
			<hr>
				...
				<div class="row">
					<div class="col-12 col-md-6 order-md-1 order-last">
						...
						<a href="/project5/addmem.do" class="badge bg-secondary">팀	할당</a> 
						<a	href="/project5/Allocation.do" class="badge bg-secondary">프로젝트 할당</a> 
							<a href="/project5/vacationMain.do" class="badge bg-secondary">휴가 관리</a> 
							<a href="/project5/attendanceMain.do" class="badge bg-secondary">근태 관리</a>
