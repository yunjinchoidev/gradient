...
<script>
	$(document).ready(function() {
						var qualitykeyValue = '<c:out value="${quality.qualitykey}"/>';
						var replyUL = $(".chat");
						...
						function showList(page) {
							...
							replyService.getList({qualitykey : qualitykeyValue,
												page : 1
											},
											function(list) {
...
<script>
	...
	/*
	 replyService.add(
	 {reply:"JS Test", replyer:"tester", qualitykey:qualitykeyValue}
	 ,
	 function(result){ 
